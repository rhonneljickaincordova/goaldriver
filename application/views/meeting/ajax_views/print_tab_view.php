...
<?php echo form_open(base_url()."index.php/meeting/print-meeting-minutes", array("method"=>"GET", "target"=>"_blank")) ?>
...
<!-- <div class="form-group">
	<label class="">
		<input id="" name="meeting_link" type="checkbox" value="yes"> Include link to meeting workspace
	</label>
</div> -->

<div class="form-group">
	<label class=""></label>
	<button type="submit" class="btn btn-primary pull-right btn-print-meeting">Print</button>
</div>
