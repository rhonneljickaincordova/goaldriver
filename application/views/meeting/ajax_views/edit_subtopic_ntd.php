...
<?php echo form_open("", array("id"=>"update-subtopic-ntd-information")) ;?>
...
<div class="form-group">
	...
	<div class="topic-title-cont">
		...
		<div>
			<input type="text" class="form-control no_enter" id="subtopic-ntd-text" value="<?php echo $ntd['text'] ?>" name="ntd_text">
		</div>
	</div>

	<div class="save-action-toolbar">
		<div>
			<button type="button" class="btn btn-primary pull-right btn-save-updated-subtopic-ntd" data-id="<?php echo $ntd['id'] ?>" style="margin-top:3px"> Update</button>
		</div>
	</div>
