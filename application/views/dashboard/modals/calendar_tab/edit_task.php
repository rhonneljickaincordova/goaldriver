	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<?php 
					$this->load->view("dashboard/modals/calendar_tab/task_comment.php"); 
				?>
				<div class="modal-footer">
					<div ng-show="show_readwrite_btn">
						<button type="button" class="btn btn-primary" ng-click="update_task()"><li class="fa fa-floppy-o"></li> Save</button>
						<button type="button" class="btn btn-default" data-dismiss="modal"><li class="fa fa-times"></li> Cancel</button>
					</div>
					<div ng-show="!show_readwrite_btn">
